...
func TestControllersReconcilers(t *testing.T) {
	RegisterFailHandler(Fail)

	RunSpecs(t, "Kubernetes reconciler suite")
}
...
var _ = BeforeSuite(func() {
	...
	var err error
	k8sBin, err := testutils.LatestK8sAssetsDir(filepath.Join("..", "..", "bin", "k8s"))
	...
	err = kindav1.AddToScheme(scheme.Scheme)
	Expect(err).NotTo(HaveOccurred())
