...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PostgresDbUser) DeepCopyInto(out *PostgresDbUser) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostgresDbUser.
func (in *PostgresDbUser) DeepCopy() *PostgresDbUser {
	if in == nil {
		return nil
	}
	out := new(PostgresDbUser)
	in.DeepCopyInto(out)
	return out
}
