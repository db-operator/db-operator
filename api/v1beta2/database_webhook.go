...
//+kubebuilder:webhook:path=/validate-kinda-rocks-v1beta2-database,mutating=false,failurePolicy=fail,sideEffects=None,groups=kinda.rocks,resources=databases,verbs=create;update,versions=v1beta2,name=vdatabase.kb.io,admissionReviewVersions=v1
