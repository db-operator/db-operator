...
// Package consts is used to store constats that are using across the project
// and might be also used by third party projects, so they are not in the internal package
package consts
